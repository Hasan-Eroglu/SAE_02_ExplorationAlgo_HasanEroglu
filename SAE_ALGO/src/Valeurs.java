...
public class Valeurs {
    ...
    /**
     * Calcule le chemin depuis le départ jusqu'à la destination
     * en remontant les parents.
     * @param destination le nœud d'arrivée
     * @return la liste des nœuds composant le chemin
     */
    public List<String> calculerChemin(String destination) {
        ...
        while (noeud != null && !noeud.equals("fin")) {
            chemin.add(0, noeud);
